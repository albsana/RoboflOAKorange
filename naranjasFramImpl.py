...
############ Carga el modelo de Yolo propio
    def cargaModelo(self):    
        model=YOLO(r'C:\Users\Servidor\Desktop\AlbertoMartinez\GUINaranjas\Modelos\yolov8X\weights\best.pt') #Modelo L Naranajas solo    
...
######################## NARANJAS ########################
        ...
        ########################## ESTIMACION TEXTO #############################
                ...
                path = r'C:/Users/Servidor/Desktop/AlbertoMartinez/GUINaranjas/DatosOAK/EstimacionOAK.xlsx'
                if self.naranjaCheckBox.GetValue() == True:    
