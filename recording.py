...
parser.add_argument('-p', '--path', default="Videos", type=str, help="Path where to store the captured data")
...
def run(quitEvent: threading.Thread = threading.Thread()):
